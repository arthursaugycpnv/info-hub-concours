...
<div class="ih-hero mb-5">
    <div class="row align-items-center g-4">
        <div class="col-lg-7">
            ...
            <h1>Bienvenue sur<br><span class="hero-accent">InfoHub</span></h1>
        ...
        <div class="col-lg-5 d-none d-lg-flex justify-content-end">
            <div class="d-flex gap-3 flex-wrap justify-content-end">
                <div class="hero-stat">
                    <div class="stat-number"><?= $db->query('SELECT COUNT(*) FROM news')->fetchColumn() ?></div>
                    <div class="stat-label">News</div>
                </div>
                <div class="hero-stat">
                    <div class="stat-number"><?= $db->query('SELECT COUNT(*) FROM annonces WHERE actif=1')->fetchColumn() ?></div>
                    <div class="stat-label">Annonces</div>
                </div>
                <div class="hero-stat">
                    <div class="stat-number"><?= $db->query('SELECT COUNT(*) FROM utilisateurs')->fetchColumn() ?></div>
