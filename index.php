...
<div class="ih-hero mb-5">
    <div class="row align-items-center g-4">
        <div class="col-lg-7">
            ...
            <h1>Bienvenue sur<br><span style="color:var(--ed-amber)">InfoHub</span></h1>
        ...
        <div class="col-lg-5 d-none d-lg-flex justify-content-end">
            <div class="d-flex gap-3 flex-wrap justify-content-end">
                <div class="text-center p-3 rounded-3" style="background:rgba(255,255,255,.05)">
                    <div class="fw-bold fs-2" style="color:var(--ed-amber)"><?= $db->query('SELECT COUNT(*) FROM news')->fetchColumn() ?></div>
                    <div class="small text-secondary">News</div>
                </div>
                <div class="text-center p-3 rounded-3" style="background:rgba(255,255,255,.05)">
                    <div class="fw-bold fs-2" style="color:var(--ed-amber)"><?= $db->query('SELECT COUNT(*) FROM annonces WHERE actif=1')->fetchColumn() ?></div>
                    <div class="small text-secondary">Annonces</div>
                </div>
                <div class="text-center p-3 rounded-3" style="background:rgba(255,255,255,.05)">
                    <div class="fw-bold fs-2" style="color:var(--ed-amber)"><?= $db->query('SELECT COUNT(*) FROM utilisateurs')->fetchColumn() ?></div>
